...
$profile_pic_query = mysql_query("INSERT INTO photos VALUES ('','oraz','$user','$date','$description','http://localhost/findfriends/userdata/user_photos/$rand_dir_name/$profile_pic_name','no','$img_id')");
